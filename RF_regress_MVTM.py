...
# Random Forest Regression on multiple factors
# Trains and evaluates a RF regressor on predicting body position locations from
...
# Set name of data set to load here. Loads ".mat" files
curr_data_set = '09_22_L_base_cat_data.mat'
out_file = '09_22_L_base_RF_MVMT_preds.mat'

# Load in data set from .mat file
# Modify here to change the loaded matrices, or to load a different format
def load_data_set():
...
print ("Random Forest Pose Regression")
print(out_file)
print("Cross Validated Scores")
print("R2: %0.4f (+/- %0.4f)" % (scores.mean(), scores.std() * 2))
